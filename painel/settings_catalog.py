...
def preset(nome: str):
    """Preset nomeado → {chave: valor} ou None."""
    return _PRESETS.get(nome)


def presets() -> list:
    saida = []
    for nome, dados in _PRESETS.items():
        saida.append({"nome": nome, "descricao": dados["descricao"],
...
_PRESETS = {
    "casual": {
        "descricao": "Jogo tranquilo: sem punição de morte, XP e captura generosos.",
        "mudancas": {"DeathPenalty": "None", "ExpRate": 1.5,
                     "PalCaptureRate": 1.5, "bHardcore": False,
                     "bFriendlyFire": False},
    },
    "normal": {
        "descricao": "Valores padrão oficiais do jogo.",
        "mudancas": {},
    },
    "hardcore": {
        "descricao": "Sem margem: morte permanente e penalidade total.",
        "mudancas": {"bHardcore": True, "DeathPenalty": "All",
                     "bEnableInvaderEnemy": True, "ExpRate": 0.75},
    },
    "pve": {
        "descricao": "Cooperativo: fogo amigo fora e invasões leves.",
        "mudancas": {"bFriendlyFire": False, "bEnableNonLethalWeapon": True,
                     "DeathPenalty": "Item"},
    },
    "pvp": {
        "descricao": "Confronto aberto: fogo amigo e drops agressivos.",
        "mudancas": {"bFriendlyFire": True, "bEnableNonLethalWeapon": False,
                     "DeathPenalty": "ItemAndEquipment"},
    },
    "small_server": {
        "descricao": "Grupo pequeno de amigos: poucos slots e bases leves.",
        "mudancas": {"ServerPlayerMaxNum": 8, "BaseCampMaxNum": 48,
                     "CoopPlayerMaxNum": 4},
    },
    "large_server": {
        "descricao": "Comunidade grande: muitos slots e bases.",
        "mudancas": {"ServerPlayerMaxNum": 32, "BaseCampMaxNum": 160,
                     "GuildPlayerMaxNum": 20, "NetServerMaxTickRate": 90},
    },
    "performance": {
        "descricao": "Aliviar CPU/RAM em máquinas modestas.",
        "mudancas": {"NetServerMaxTickRate": 60, "DropItemMaxNum": 1500,
                     "PalSpawnNumRate": 0.8, "bIsShowPlayerList": False},
    },
    "xp_rapido": {
        "descricao": "Progressão acelerada.",
        "mudancas": {"ExpRate": 5.0, "PalCaptureRate": 2.0,
                     "PalEggDefaultHatchingTime": 12.0},
    },
    "farm_rapido": {
        "descricao": "Recursos e trabalho em ritmo alto.",
        "mudancas": {"WorkSpeedRate": 2.0, "CollectionDropRate": 3.0,
